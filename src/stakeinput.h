...
#ifndef C0_STAKEINPUT_H
#define C0_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZC0() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zC0Stake can take two forms
...
public:
    ...
    bool IsZC0() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZC0() override { return false; }
};


#endif //C0_STAKEINPUT_H
