...
#ifndef C0_ZC0WALLET_H
#define C0_ZC0WALLET_H
...
public:
    CzC0Wallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZC0(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZC0(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //C0_ZC0WALLET_H
