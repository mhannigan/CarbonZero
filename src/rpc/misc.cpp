...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"zC0supply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zC0 denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zC0 denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zC0 denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zC0 denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zC0 denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zC0 denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zC0 denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zC0 denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zC0 denominations\n"
            "  }\n"
    ...
    obj.push_back(Pair("zC0supply", zpivObj));
...
#ifdef ENABLE_WALLET
        // Case 1: C0 address and we have full public key:
