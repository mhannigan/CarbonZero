...
WalletModel::SendCoinsReturn WalletModel::prepareTransaction(WalletModelTransaction& transaction, const CCoinControl* coinControl)
{
...

    {
        ...
        if (recipients[0].useSwiftTX && total > GetSporkValue(SPORK_5_MAX_VALUE) * COIN) {
            emit message(tr("Send Coins"), tr("SwiftX doesn't support sending values that high yet. Transactions are currently limited to %1 C0.").arg(GetSporkValue(SPORK_5_MAX_VALUE)),
...
static void NotifyzC0Reset(WalletModel* walletmodel)
{
    qDebug() << "NotifyzC0Reset";
...
void WalletModel::subscribeToCoreSignals()
{
    ...
    wallet->NotifyzC0Reset.connect(boost::bind(NotifyzC0Reset, this));
...
void WalletModel::unsubscribeFromCoreSignals()
{
    ...
    wallet->NotifyzC0Reset.disconnect(boost::bind(NotifyzC0Reset, this));
