...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 51372;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // C0 starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // C0: 1 day
        nTargetSpacing = 1 * 60;  // C0: 1 minute
        nMaturity = 100;
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // C0: 1 day
        nTargetSpacing = 1 * 60;        // C0: 1 minutes
