...
*Setup instructions for a gitian build of C0 using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the C0
...
- [Building C0](#building-carbonzero)
...
To build C0 (for Linux, OSX and Windows) just follow the steps under 'perform
