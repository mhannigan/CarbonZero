Contributing to C0 Core
============================

The C0 Core project operates an open contributor model where anyone is
...
The following applies to code changes to the C0 Core project, and is not to be
confused with overall C0 Network Protocol consensus changes.

Whether a pull request is merged into C0 Core rests with the project merge
...
Patches that change C0 consensus rules are considerably more involved than
...
Where a patch set proposes to change the C0 consensus, it must have been
...
The project leader is the release manager for each C0 Core release.
