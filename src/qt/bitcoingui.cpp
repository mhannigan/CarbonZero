                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("C0 Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a C0 address"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zC0"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About C0 Core"), this);
    aboutAction->setStatusTip(tr("Show information about C0 Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for C0"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your C0 addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified C0 addresses"));
    ...
    openAction->setStatusTip(tr("Open a C0: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the C0 Core help message to get a list with possible C0 command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("C0 Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to C0 network", "", count));
}
...
{
    QString strTitle = tr("C0 Core"); // default title
