...
Setup
---------
Configuring the github-merge tool for the C0 repository is done in the following way:

    git config githubmerge.repository C0-Project/C0
...
A script to optimize png files in the C0
